...
#---------------------year----------------------input----------------------------------output---------------------------sample--discriminant 
...
./Fit_el_CMSShape.exe 2018 ../PrepareHistograms/output_el_2018/Embedded_HLTMu23Ele12.root output_Embedded_2018_HLTMu23Ele12.root Embedded HLTMu23Ele12
python ScaleFactors_el.py --year=2018 --discriminant=HLTMu23Ele12

#Don't need single electron or ETau cross trigger
