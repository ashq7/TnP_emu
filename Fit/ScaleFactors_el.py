...
for i in range(0,8):
   ...
   #eff1D_data.GetYaxis().SetTitle("Data Efficiency")
   ...
   # eff1D_embedded.SetMinimum(0.2)
   # eff1D_embedded.SetMaximum(1.2)
   # eff1D_embedded.Draw("hist")
   # eff1D_data.Draw("histsame")
...
def plot_sf_comparison(sf_list, label, output_name):
    ...
    ROOT.gPad.RedrawAxis()
    c.Modified()
    c.SaveAs("forAN/plots_el_{}/{}.png".format(args.year, output_name))
    c.SaveAs("forAN/plots_el_{}/{}.pdf".format(args.year, output_name))

plot_sf_comparison(sf_mc, "MC Scale Factors", "sf_el_mc_{}_{}".format(args.year, args.discriminant))
plot_sf_comparison(sf_embedded, "Embedded Scale Factors", "sf_el_embedded_{}_{}".format(args.year, args.discriminant))
