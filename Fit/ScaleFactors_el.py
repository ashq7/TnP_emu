...
file_data=ROOT.TFile("output_el_2018/output_Data_"+args.year+"_"+args.discriminant+".root","r")
file_mc=ROOT.TFile("output_el_2018/output_DY_"+args.year+"_"+args.discriminant+".root","r")
file_embedded=ROOT.TFile("output_el_2018/output_Embedded_"+args.year+"_"+args.discriminant+".root","r")
