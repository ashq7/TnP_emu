...
for i in range(0,8):
   ...
   eff1D_embedded=ROOT.TH1F("eff1_mc","eff1D_mc",nb_bins,array('d',bins_pt))
   ...
   ratio_mc.GetXaxis().SetTitleSize(0.15)
   ...
   ratio_embedded.GetXaxis().SetTitleSize(0.15)
   ratio_embedded.GetYaxis().SetTitleSize(0.15)
   ratio_embedded.GetYaxis().SetTitleOffset(0.56)
   ...
   #c.SaveAs("plots_el_"+args.year+"/sf_el_"+args.year+"_"+args.discriminant+"_etabin"+str(i)+".pdf")
...
ROOT.gPad.RedrawAxis()
c.Modified()
c.SaveAs("plots_el_"+args.year+"/sf_el_mc_"+args.year+"_"+args.discriminant+".png")
c.SaveAs("plots_el_"+args.year+"/sf_el_mc_"+args.year+"_"+args.discriminant+".pdf")
...
ROOT.gPad.RedrawAxis()
c.Modified()
c.SaveAs("plots_el_"+args.year+"/sf_el_embedded"+args.year+"_"+args.discriminant+".png")
c.SaveAs("plots_el_"+args.year+"/sf_el_embedded"+args.year+"_"+args.discriminant+".pdf")
...
ROOT.gPad.RedrawAxis()
c.Modified()
c.SaveAs("plots_el_"+args.year+"/sf_el_mc_eta_"+args.year+"_"+args.discriminant+".png")
c.SaveAs("plots_el_"+args.year+"/sf_el_mc_eta_"+args.year+"_"+args.discriminant+".pdf")

sf_embedded_eta[5].SetLineColor(ROOT.kGreen+1)
sf_embedded_eta[5].SetMarkerColor(ROOT.kGreen+1)
sf_embedded_eta[5].SetMarkerStyle(20)
sf_embedded_eta[5].SetLineWidth(3)
sf_embedded_eta[4].SetLineColor(ROOT.kOrange+1)
sf_embedded_eta[4].SetMarkerColor(ROOT.kOrange+1)
sf_embedded_eta[4].SetMarkerStyle(20)
sf_embedded_eta[4].SetLineWidth(3)
sf_embedded_eta[3].SetLineColor(ROOT.kBlack)
sf_embedded_eta[3].SetMarkerColor(ROOT.kBlack)
sf_embedded_eta[3].SetMarkerStyle(20)
sf_embedded_eta[3].SetLineWidth(3)
sf_embedded_eta[2].SetLineColor(ROOT.kGray+1)
sf_embedded_eta[2].SetMarkerColor(ROOT.kGray+1)
sf_embedded_eta[2].SetMarkerStyle(20)
sf_embedded_eta[2].SetLineWidth(3)
sf_embedded_eta[1].SetLineColor(ROOT.kRed+1)
sf_embedded_eta[1].SetMarkerColor(ROOT.kRed+1)
sf_embedded_eta[1].SetMarkerStyle(20)
sf_embedded_eta[1].SetLineWidth(3)
sf_embedded_eta[0].SetLineColor(ROOT.kRed-2)
sf_embedded_eta[0].SetMarkerColor(ROOT.kRed-2)
sf_embedded_eta[0].SetMarkerStyle(20)
sf_embedded_eta[0].SetLineWidth(3)

file_out.cd()
sf_embedded_eta[0].SetName("sf_embedded_eta_pt15to20")
sf_embedded_eta[1].SetName("sf_embedded_eta_pt20to35")
sf_embedded_eta[2].SetName("sf_embedded_eta_pt35to50")
sf_embedded_eta[3].SetName("sf_embedded_eta_pt50to75")
sf_embedded_eta[4].SetName("sf_embedded_eta_pt75to100")
sf_embedded_eta[5].SetName("sf_embedded_eta_pt100to200")
...
sf_embedded_eta[3].SetMaximum(1.12)
sf_embedded_eta[3].SetMinimum(0.78)
sf_embedded_eta[3].Draw("ep")
sf_embedded_eta[5].Draw("epsame")
sf_embedded_eta[4].Draw("epsame")
if args.discriminant=="HLTEle25" or args.discriminant=="HLTEle24Tau30" or args.discriminant=="HLTMu8Ele23" or args.discriminant=="HLTMu23Ele12" or args.discriminant=="MVAisoWP80":
   sf_embedded_eta[1].Draw("epsame")
if args.discriminant=="HLTMu23Ele12" or args.discriminant=="MVAisoWP80":
   sf_embedded_eta[0].Draw("epsame")
sf_embedded_eta[2].Draw("epsame")
sf_embedded_eta[3].Draw("epsame")

c.cd()
pad1.Draw()
ROOT.gPad.RedrawAxis()
c.Modified()
c.SaveAs("plots_el_"+args.year+"/sf_el_embedded_eta_"+args.year+"_"+args.discriminant+".png")
c.SaveAs("plots_el_"+args.year+"/sf_el_embedded_eta_"+args.year+"_"+args.discriminant+".pdf")