...
config.General.requestName = "Muon_Embedded_2016preE"
...
config.Data.inputDataset = '/EmbeddingRun2016-HIPM_E/MuonEmbedding-inputDoubleMu_106X_ULegacy_miniAOD-v1/USER'
