...
config.General.requestName = "EGamma_embedded_2018C"
config.General.workArea = "crab_projects"
config.General.transferLogs = True
config.General.transferOutputs = True

config.JobType.pluginName = "Analysis"
config.JobType.psetName = "run_Electron_Embedded_2018.py"
config.JobType.maxMemoryMB = 4000
#config.JobType.numCores = 8

config.section_("Data")
config.Data.inputDataset = '/EmbeddingRun2018C/ElectronEmbedding-inputDoubleMu_106X_ULegacy_miniAOD-v1/USER'
...
config.Data.outputDatasetTag = "TnP_ntuples_embedded_DataC_el2018"
