...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        '/store/group/rucio/pog_tau_group/ul_embedding/large_miniAOD_v2/ElMuFinalState/EmbeddingRun2017B/MINIAOD/inputDoubleMu_106X_ULegacy_miniAOD-v1/0000/00a6e0d7-2a9a-4770-8cb0-e437fb819c8b.root', #just changed year from 2018, might not be real file
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("histo_Electron_Embedded_2017.root"),
