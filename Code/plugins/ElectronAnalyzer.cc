...
ElectronAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
    ...
    if (nElectrons==2){ 
	 ...
	 tag_dxy = (*electrons)[index_el1].gsfTrack()->dxy(reco::TrackBase::Point(pv_x, pv_y, pv_z));
      ...
      //probe_MVAnoIsoWP90=(*electrons)[index_el2].electronID("Electron_mvaFall17V2noIso_WP90");
      //probe_MVAnoIsoWP80=(*electrons)[index_el2].electronID("Electron_mvaFall17V2noIso_WP80");
      //probe_MVAnoIsoWPLoose=(*electrons)[index_el2].electronID("Electron_mvaFall17V2noIso_WPL");
